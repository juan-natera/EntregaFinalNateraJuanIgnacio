...
# Estos modelos funcionan como clases, son las tablas en la base de datos
...
# con esta indicación comenzamos a ver detalladamente en nuestro BD
    def __str__(self):return f"Nombre: {self.nombre} - Apellido {self.apellido} - E-Mail {self.email} - Profesión {self.profesion}"
